...
import please.help.commands.Add;
...
public class Address implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (this.street == null && otherAddr.getStreet() != null) return false;
        if (this.zipCode == null && otherAddr.getZipCode() != null) return false;
        if (this.street != null && !otherAddr.getStreet().equals(this.street)) return false;
        if (this.zipCode != null && !otherAddr.getZipCode().equals(this.zipCode)) return false;
        return true;
    }
